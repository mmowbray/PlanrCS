var semester=["Online", "Fall/Winter", "Fall", "Winter", "Summer1", "Summer2", "Summer"]; 
	...
	$(document).ready(function() {
		$.get("/Admin/GetSections/",function(response){
	...
	// TODO: change save to editSave, addSave.
		...
		*/
		...
		function saveAddSection()
		{
			...
			if (validateInputAdd())
			{
				$.get( "/Admin/AddSection", section, function(responseCode ) {
						if(responseCode==0) 
		...
		{
			$.get( "/Admin/DeleteSection", {"sectionUniqueID":sectionID}, function( responseCode ) {
