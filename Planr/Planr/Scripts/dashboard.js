...
Planr.controller('SequenceCtrl', function ($scope) {
    ...
    var sequenceObj = new Sequence('/Student/GetSequence', 'someID', function () { console.log('prefs'); });
    //fetch from server
...
Planr.controller('RecordCtrl', function ($scope) {
    //instantiate new obj
    var recordObj = new StudentRecord('/Student/ViewRecord', 'someID');
    //fetch from server
...
Planr.controller('PreferencesCtrl', function ($scope) {
    //instantiate new obj
    var prefObj = new Preferences('/Student/GetSavedPreferences', '/Student/SavePreferences', 'someID');
